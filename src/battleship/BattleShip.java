...
class BattleShip {
    ...
    public void showMessage(GameStatus status) {
        ...
        switch (status) {
            case AIRCRAFT:
                message = "Enter the coordinates of the Aircraft Carrier (5 cells):\n";
                break;
            case BATTLESHIP:
                message = "Enter the coordinates of the Battleship (4 cells):\n";
                break;
            case SUBMARINE:
                message = "Enter the coordinates of the Submarine (3 cells):\n";
                break;
            case CRUISER:
                message = "Enter the coordinates of the Cruiser (3 cells):\n";
                break;
            case DESTROYER:
                message = "Enter the coordinates of the Destroyer (2 cells):\n";
                break;
            default:
        }
